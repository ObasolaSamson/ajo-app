      ...
      <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm p-6 sm:p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            {isOrganizer && (
              <Link
                href={`/dashboard/circles/${id}/manage`}
                className="inline-flex items-center gap-1.5 rounded-lg bg-ajo px-3.5 py-2 text-sm font-semibold text-white hover:bg-ajo-dark transition-colors"
              >
                <CogIcon /> Manage Circle
              </Link>
            )}
          </div>
        </div>
